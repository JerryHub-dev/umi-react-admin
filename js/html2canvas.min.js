    ...
    or = {
      ...
      parse: function (n, A) {
        return 1 === A.length && jA(A[0], 'none')
          ...
          : Ae(A).map(function (A) {
              for (
                var e = { color: 255, offsetX: ae, offsetY: ae, blur: ae, spread: ae, inset: !1 }, t = 0, r = 0;
                r < A.length;
                r++
              ) {
                var B = A[r];
                jA(B, 'inset')
                  ? (e.inset = !0)
                  : ee(B)
                  ? (0 === t ? (e.offsetX = B) : 1 === t ? (e.offsetY = B) : 2 === t ? (e.blur = B) : (e.spread = B),
                    t++)
                  : (e.color = ue(n, B));
              }
              return e;
  ...
  var ss = function (A, e, t, r, B) {
    ...
    as =
      ((gs.prototype.getEffects = function (e) {
        for (
          var A = -1 === [2, 3].indexOf(this.container.styles.position), t = this.parent, r = this.effects.slice(0);
          t;
          ...
          switch (A.label) {
            ...
            case 1:
              ...
              (l = {
                ...
                backgroundColor: i,
                scale:
                  null !== (l = null !== (l = F.scale) && void 0 !== l ? l : t.devicePixelRatio) && void 0 !== l
                    ? l
                    : 1,
            ...
            case 3:
              return (
                ...
                g.logger.debug(
                  'Starting renderer for element at ' + l.x + ',' + l.y + ' with size ' + l.width + 'x' + l.height,
                ),
